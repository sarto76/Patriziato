...
<html lang="en">
  ...
  <body>
	...
	if(isset($_POST['ins'])){
		...
		$sql = "INSERT INTO info(titolo, contenuto) VALUES ('$titolo', '$contenuto')";
    ...
    if(isset($_POST['butt'])){
		...
		//se è una modifica
		if($mod=='update'){
			$sql="UPDATE info SET titolo='$titolo', contenuto='$contenuto' WHERE id=$id";
			$result = $connection->query($sql);
			header('Location: info.php');
		}
	}
