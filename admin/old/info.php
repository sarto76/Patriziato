      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="info.php">Gestione Info</a>
          </div>
...
      $('#info').DataTable( {
    ...
    $connection=Database::getConnection();
		$result=$connection->query("SELECT * FROM info");
    if(mysqli_num_rows($result) == 0){
      ...
      echo('<table width="100%" class="table table-striped table-bordered dt-responsive" id="info" cellspacing="0">');
        echo('<thead>');
          echo('<tr>');
            echo("<th>titolo</th>");
        ...
        echo("<td>".$contenuto."</td>"); 
				...
				echo('<td><a href="updateInfo.php?mod=update&id=' . $row['id'] . '"><button class="btn btn-warning" type="button">Modifica</button></a></td>');  
				echo('<td><a href="updateInfo.php?mod=del&id=' . $row['id'] . '"><button class="btn btn-danger" type="button">Elimina</button></a></td>');   
				echo('</tr>');
        ...
        echo('<a href="updateInfo.php?mod=ins"><button class="btn btn-primary" type="button">Inserisci</button></a>');   
