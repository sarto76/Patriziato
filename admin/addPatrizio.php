...
<div class="container">
    ...
    echo("<input type='text' class='form-control' name='no_registro' >");
    echo("<p></p>");
    ...
    echo("<input type='text' class='form-control' name='padre'  >");
    echo("<p></p>");
    ...
    echo("<input type='text' class='form-control' name='madre'  >");
    ...
    echo("<input type='text' class='form-control' name='nap'  >");
    echo("<p></p>");

    echo('<label >Localit&agrave;:</label>');


    echo("<input type='text' class='form-control' name='localita'  >");
    echo("<p></p>");
    ...
    echo("<p></p>");
    echo('<input class="btn btn-primary" type="submit" value="crea" name="butt"></input>');
